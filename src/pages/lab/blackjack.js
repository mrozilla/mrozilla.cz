...
import { renderBlocks, persist, animation, pagePropTypes } from '~utils';
          ...
          >
            ...
            >
              {this.state.bank === 0 && this.state.bet === 0 && (
                <>
                  <Button look="primary" onClick={this.handleReset}>
                    Reset
                  </Button>
                  <Ul
                    css={`
