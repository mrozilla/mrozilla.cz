...
>
  <div>
    <div style={{ backgroundColor: "hsla(var(--hsl-text), 0.25)", paddingBottom: "100%" }} />
  </div>
  <div>
    <div style={{ backgroundColor: "hsla(var(--hsl-text), 0.25)", paddingBottom: "100%" }} />
  </div>
...
>
  <div style={{ padding: "4rem 0 0 0", backgroundColor: "hsla(var(--hsl-success), 0.1)" }}>
    <div style={{ backgroundColor: "hsla(var(--hsl-text), 0.25)", paddingBottom: "100%" }} />
  </div>
  <div style={{ padding: "0 4rem 0 0", backgroundColor: "hsla(var(--hsl-success), 0.1)" }}>
    <div style={{ backgroundColor: "hsla(var(--hsl-text), 0.25)", paddingBottom: "100%" }} />
  </div>
  <div style={{ padding: "0 0 4rem 0", backgroundColor: "hsla(var(--hsl-success), 0.1)" }}>
    <div style={{ backgroundColor: "hsla(var(--hsl-text), 0.25)", paddingBottom: "100%" }} />
  </div>
  <div style={{ padding: "0 0 0 4rem", backgroundColor: "hsla(var(--hsl-success), 0.1)" }}>
    <div style={{ backgroundColor: "hsla(var(--hsl-text), 0.25)", paddingBottom: "100%" }} />
  </div>
  <div style={{ padding: "0 0 4rem 0", backgroundColor: "hsla(var(--hsl-success), 0.1)" }}>
    <div style={{ backgroundColor: "hsla(var(--hsl-text), 0.25)", paddingBottom: "100%" }} />
